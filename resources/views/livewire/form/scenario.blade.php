        ...
        <tbody>
            ...
            <form wire:submit="temporary">
                ...
                <tr wire:key="{{ $scenarioIndex }}">
                    <div class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-16 py-4 space-y-2">
                            <input type="text" wire:model.blur="scenarios.{{ $scenarioIndex }}.scenario_name" id="" cols="30" rows="10" class="rounded border border-gray-200 bg-gray-100" placeholder="Scenario Name" />
                ...
                <tr wire:key="step-{{ $scenarioIndex }}-{{ $caseIndex }}-{{ $stepIndex }}">
                    ...
                    <td colspan="2"></td>
                    <td class="px-6 py-4">
                        <input type="text" wire:model.blur="scenarios.{{ $scenarioIndex }}.cases.{{ $caseIndex }}.steps.{{ $stepIndex }}.test_step_id" class="w-full rounded border border-gray-300" value="TS-{{ $stepIndex }}" readonly>
                    ...
                    <td class="px-6 py-4">
                        <textarea wire:model.blur="scenarios.{{ $scenarioIndex }}.cases.{{ $caseIndex }}.steps.{{$stepIndex}}.test_step" cols="30" rows="10" class="rounded border border-gray-200 bg-gray-100" placeholder="Test Step"></textarea>
                        @error('scenarios.*.cases.*.steps.*.test_step')
                        <span class="text-red-800">{{$message}}</span>
                        @enderror
                    </td>
                    <td class="px-6 py-4">
                        <textarea wire:model.blur="scenarios.{{ $scenarioIndex }}.cases.{{ $caseIndex }}.steps.{{ $stepIndex }}.expected_result" cols="30" rows="10" class="rounded border border-gray-200 bg-gray-100" placeholder="Expected Result"></textarea>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <select wire:model.blur="scenarios.{{ $scenarioIndex }}.cases.{{ $caseIndex }}.steps.{{ $stepIndex }}.category" class="w-full bg-white border border-gray-200 rounded-lg">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <select wire:model.blur="scenarios.{{ $scenarioIndex }}.cases.{{ $caseIndex }}.steps.{{ $stepIndex }}.severity" class="w-full bg-white border border-gray-200 rounded-lg">
                            <option value="">Pilih</option>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <select wire:model.blur="scenarios.{{ $scenarioIndex }}.cases.{{ $caseIndex }}.steps.{{ $stepIndex }}.status" class="w-full bg-white border border-gray-200 rounded-lg">
                            <option value="">Pilih</option>
