<div class="w-full flex justify-end">
    ...
    <button wire:click="updateMember" id="addUser" type="button" class="text-white bg-bsi-primary hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-bsi-primary dark:hover:bg-teal-700 dark:focus:ring-teal-800">
        <span class="sr-only">Icon description</span>
        Save existing members
    </button>
</div>
<div class="flex flex-col gap-2">
    <form wire:submit="updateMember" class="flex flex-col gap-2 w-full">
        ...
        @endforeach
        <!-- <button type="submit" id="addUser" type="button" class="text-white bg-bsi-primary hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-bsi-primary dark:hover:bg-teal-700 dark:focus:ring-teal-800">
            <span class="sr-only">Icon description</span>
            Save existing members
        </button> -->
    </form>
