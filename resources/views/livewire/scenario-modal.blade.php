<div wire:model="scenarioView" id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <tbody>
                                ...
                                <tr class="border border-black">
                                    ...
                                    <td class="border border-black" rowspan="{{ $totalSteps }}">
                                        <input wire:model="scenario_name" type="text" class="w-full" value="{{ $scenario->scenario_name }}">
                                    </td>
                                    ...
                                    <td class="border border-black" rowspan="{{ $rowCount }}">
                                        <input type="text" class="w-full" value="{{ $case->case }}">
                                    </td>
                                    @endif

                                    <td class="border border-black">{{ $step->test_step_id }}</td>
                                    <td class="border border-black">
                                        <input type="text" class="w-full" value="{{ $step->test_step }}">

                                    </td>
                                    <td class="border border-black">
                                        <input type="text" class="w-full" value="{{ $step->expected_result }}">

                                    </td>
                                    <td class="border border-black">
                                        <select class="w-full bg-white border border-gray-200 rounded-lg">
            ...
            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 gap-2">
                ...
                <button wire:click="update" data-modal-hide="default-modal" type="submit" class="text-white bg-bsi-primary hover:bg-teal-700 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
            </div>
        </div>
    </div>
</div>