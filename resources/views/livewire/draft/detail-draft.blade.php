<div class="pt-4 flex flex-col w-full h-fit space-y-2">
    ...
    <section>
        ...
        <div class="mb-5">
            ...
            <input type="text" wire:model.live="name" id="name-input" value="{{ $project->values['project']['name'] }}" placeholder="Masukkan Nama Project" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @error('name')
        ...
        <div class="mb-5">
            ...
            <select wire:model.debounce.800ms="test_level_id" id="test_level" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option value="{{ $project->values['project']['test_level_id'] }}">{{ $project->test_level->type }}</option>
            </select>
            @error('test_level')
            <span class="text-red-800">{{$message}}</span>
            @enderror
        ...
        <div class="mb-5">
            ...
            <input wire:model="test_type" id="test_type" type="text" value="{{ $project->values['project']['test_type'] }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @error('test_type')
            <span class="text-red-800">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-5">
            ...
            <div class="flex w-full items-center">
                <div class="relative">
                    ...
                    <input wire:model.live="start_date" type="date" value="{{ $project->values['project']['start_date'] }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
                </div>
                ...
                <div class="relative">
                    ...
                    <input wire:model.live="end_date" type="date" value="{{ $project->values['project']['end_date'] }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date end">
                </div>
            </div>
            @error('start_date')
            <span class="text-red-800">{{$message}}</span>
        ...
        <div class="mb-5">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rounded rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse($project['values']['issue'] as $data)
    ...
    <section>
        ...
        <div class="mb-5">
            ...
            <input type="text" wire:model="scope" id="scope-input" value="{{ $project->values['project']['scope'] }}" placeholder="Scope" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @error('scope')
            <span class="text-red-800">{{$message}}</span>
            @enderror
        </div>
    ...
    <section>
        <div class="mb-5">
            ...
            <input type="text" wire:model="env" id="env-input" value="{{ $project->values['project']['env'] }}" placeholder="Test Environment" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @error('env')
            <span class="text-red-800">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-5">
            ...
            <input type="text" wire:model="credentials" id="credentials-input" value="{{ $project->values['project']['credentials'] }}" placeholder="Credentials" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @error('credentials')
            <span class="text-red-800">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-5">
            ...
            <input type="text" wire:model="other" id="other-input" value="{{ $project->values['project']['other'] }}" placeholder="Other notes" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @error('other')
            <span class="text-red-800">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-5">
            ...
            <input type="text" wire:model="retesting" id="restest-input" value="{{ $project->values['project']['retesting'] }}" placeholder="Retesting" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @error('retesting')
            <span class="text-red-800">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="flex flex-col gap-2 mt-4">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rounded rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach($project['values']['users'] as $data)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-t-lg">
            ...
            <table class="w-full mt-4 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    @foreach($project['values']['scenario'] as $scenario)
                    @php
                    $scenarioNumber++;
                    $totalSteps = 0;
