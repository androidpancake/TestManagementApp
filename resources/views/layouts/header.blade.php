    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="https://ir.bankbsi.co.id/" class="flex ms-2 md:me-24">
          <img src="{{ asset('storage/image/logo/bsi.png') }}" class="h-8 me-3" alt="FlowBite Logo" />
        </a>
      </div>
      <div class="flex items-center">
        <div class="flex items-center gap-3 ms-3">
          ...
          <div class="font-medium text-sm text-gray-800 dark:text-gray-100">role</div>
          <div>
